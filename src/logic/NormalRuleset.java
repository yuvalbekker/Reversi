...
public class NormalRuleset extends Logic {

    public NormalRuleset(Board b) {
        super(b);
    }
    ...
    public ArrayList<Position> calcPossibleMoves(Player player) {
        int i = 0;
        int j = 0;
            ...
            for (j = 0; j < getBoardClass().getSize(); j++) {
                ...
                if (i == getBoardClass().getSize() - 1 && j != 0) {
                    if (checkUp(checker.getPosition(), player)
                            ...
                            || checkUpRight(checker.getPosition(), player)
                            || checkUpLeft(checker.getPosition(), player)) {
                        moves.add(getBoardClass().getBoard()[i][j].getPosition());
                    }
                    continue;
                }
    ...
    public boolean checkRight(Position pos, Player player) {
    ...
    public boolean checkLeft(Position pos, Player player) {
        boolean enemyEncountered = false;
    ...
    public boolean checkUp(Position pos, Player player) {
        boolean enemyEncountered = false;
    ...
    public boolean checkDown(Position pos, Player player) {
        boolean enemyEncountered = false;
    ...
    public boolean checkUpRight(Position pos, Player player) {
        int j = pos.col + 1;
        boolean enemyEncountered = false;
    ...
    public boolean checkUpLeft(Position pos, Player player) {
        int j = pos.col - 1;
        boolean enemyEncountered = false;
    ...
    public boolean checkDownRight(Position pos, Player player) {
        int j = pos.col + 1;
        boolean enemyEncountered = false;
    ...
    public boolean checkDownLeft(Position pos, Player player) {
        int j = pos.col - 1;
        boolean enemyEncountered = false;
